...
class AppointmentBloc extends Bloc<AppointmentEvent, AppointmentState> {
  ...
  Future<void> _onFetchSpecialistAppointments(
    ...
    try {
      final appointments = await _apiRepository.getSpecialistAppointments(event.specialistId);
  ...
  Future<void> _onAcceptAppointment(
    ...
    emit(AppointmentLoading());
    try {
      final appointment = await _apiRepository.acceptAppointment(event.appointmentId);
  ...
  Future<void> _onDeclineAppointment(
    ...
    emit(AppointmentLoading());
    try {
      final appointment = await _apiRepository.declineAppointment(event.appointmentId);
